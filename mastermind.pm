...
BobboBot::module::addCommand('mastermind', 'run', \&BobboBot::mastermind::run);
BobboBot::module::addCommand('mastermind', 'help', \&BobboBot::mastermind::help);
BobboBot::module::addCommand('mastermind', 'auth', \&BobboBot::mastermind::auth);
